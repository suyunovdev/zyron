...
import {
  Brain, Cloud, Smartphone, Shield, Activity,
  Zap, LayoutDashboard, Gauge, Server, Lock,
} from "lucide-react";
import { useLanguage } from "@/lib/LanguageContext";
import { translations, t } from "@/lib/translations";

const icons = [Brain, Cloud, Smartphone, Shield, Activity, Zap, LayoutDashboard, Gauge, Server, Lock];
          ...
          {tr.items.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className="group text-center p-6 rounded-2xl bg-card border border-border hover:border-secondary/30 transition-all duration-300"
              >
